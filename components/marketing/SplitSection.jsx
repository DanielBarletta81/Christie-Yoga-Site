      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-10 px-6">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <div id="ayurveda" className="group overflow-hidden rounded-3xl bg-white/70 transition hover:-translate-y-1">
            <div
              className="h-72 bg-cover bg-center grayscale transition duration-500 group-hover:grayscale-0 md:h-80"
              style={{ backgroundImage: `url('${CDN_BASE}/ayurveda.jpg')` }}
            />
          ...
          <div className="group overflow-hidden rounded-3xl bg-white/70 transition hover:-translate-y-1">
            <div
              className="h-72 bg-cover bg-center grayscale transition duration-500 group-hover:grayscale-0 md:h-80"
              style={{ backgroundImage: `url('${CDN_BASE}/wellness.jpg')` }}
            />
            <div className="px-8 py-10">
