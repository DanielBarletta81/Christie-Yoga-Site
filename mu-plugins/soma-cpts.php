...
if (function_exists('acf_add_local_field_group')) {
  ...
  acf_add_local_field_group([
    ...
    'fields' => [
      ...
      [
        'key' => 'field_chakra_suggested_sounds',
        'label' => 'Suggested Sounds',
        'name' => 'suggested_sounds',
        'type' => 'relationship',
        'post_type' => ['sound'],
        'return_format' => 'id',
      ],
  ...
  acf_add_local_field_group([
    ...
    'fields' => [
      ['key' => 'field_ritual_is_active', 'label' => 'Is Active', 'name' => 'is_active', 'type' => 'true_false', 'default_value' => 1],
  ...
  acf_add_local_field_group([
    'key' => 'group_soma_pose_details',
    'title' => 'Pose Details',
    'fields' => [
      ['key' => 'field_pose_sanskrit', 'label' => 'Sanskrit Name', 'name' => 'sanskrit', 'type' => 'text'],
      ['key' => 'field_pose_summary', 'label' => 'Summary', 'name' => 'summary', 'type' => 'textarea'],
      [
        'key' => 'field_pose_cues',
        'label' => 'Cues',
        'name' => 'cues',
        'type' => 'repeater',
        'sub_fields' => [
          ['key' => 'field_pose_cue_label', 'label' => 'Cue', 'name' => 'label', 'type' => 'text'],
        ],
      ],
      [
        'key' => 'field_pose_modifications',
        'label' => 'Modifications',
        'name' => 'modifications',
        'type' => 'repeater',
        'sub_fields' => [
          ['key' => 'field_pose_modification_label', 'label' => 'Modification', 'name' => 'label', 'type' => 'text'],
        ],
      ],
      [
        'key' => 'field_pose_benefits',
        'label' => 'Benefits',
        'name' => 'benefits',
        'type' => 'repeater',
        'sub_fields' => [
          ['key' => 'field_pose_benefit_label', 'label' => 'Benefit', 'name' => 'label', 'type' => 'text'],
        ],
      ],
      ['key' => 'field_pose_history', 'label' => 'History', 'name' => 'history', 'type' => 'textarea'],
      ['key' => 'field_pose_more_link_label', 'label' => 'More Link Label', 'name' => 'more_link_label', 'type' => 'text'],
      ['key' => 'field_pose_more_link_url', 'label' => 'More Link URL', 'name' => 'more_link_url', 'type' => 'url'],
      [
        'key' => 'field_pose_skeleton_json',
        'label' => 'Skeleton JSON',
        'name' => 'skeleton_json',
        'type' => 'textarea',
        'instructions' => 'JSON for pose joint coordinates.',
      ],
      [
        'key' => 'field_pose_angles_json',
        'label' => 'Angles JSON',
        'name' => 'angles_json',
        'type' => 'textarea',
        'instructions' => 'JSON for angle overlays.',
      ],
      [
        'key' => 'field_pose_angle_labels_json',
        'label' => 'Angle Labels JSON',
        'name' => 'angle_labels_json',
        'type' => 'textarea',
        'instructions' => 'JSON for angle labels.',
      ],
      [
        'key' => 'field_pose_mod_overlays_json',
        'label' => 'Modification Overlays JSON',
        'name' => 'mod_overlays_json',
        'type' => 'textarea',
        'instructions' => 'JSON for modification overlays.',
      ],
    ],
    'location' => [
      [
        ['param' => 'post_type', 'operator' => '==', 'value' => 'pose'],
      ],
    ],
  ]);
}
